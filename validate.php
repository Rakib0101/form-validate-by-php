...
//Email Address Validation
 $conn = mysqli_connect("localhost", "root", "", "users") or die("connection is failed");
...
{   
   ...
   // here you can write Sql Query to insert user data into database table
    ...
    $sql = "INSERT INTO user_info(first_name, last_name, email, password) VALUES ('{$firstName}', '{$lastName}', '{$email}', '{$password}')";
...
// convert illegal input value to legal value formet
